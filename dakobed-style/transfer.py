...
width, height = load_img(basefilepath).size
img_nrows = 400
...
base_image = K.variable(preprocess_image(basefilepath))
style_reference_image = K.variable(preprocess_image(stylefilepath))
...
x = preprocess_image(basefilepath)
