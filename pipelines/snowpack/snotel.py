...
#         print(e)
#
# dynamo = boto3.resource('dynamodb', region_name='us-west-2',endpoint_url="http://dynamodb:8000")
#
...
# create_locations_table(dynamo)
#
# dynamo = boto3.client('dynamodb',region_name='us-west-2', endpoint_url='http://dynamodb:8000')
